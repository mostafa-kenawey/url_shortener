defmodule UrlShortenerWeb.Admin.LinkLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :links, Admin.list_links())}
  end
  ...
  @impl true
  def handle_info({UrlShortenerWeb.Admin.LinkLive.FormComponent, {:saved, link}}, socket) do
