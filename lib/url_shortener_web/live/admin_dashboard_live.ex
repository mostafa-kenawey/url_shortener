              ...
              <div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
                ...
                >
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"
                  >
                  </path>
                </svg>
              </div>
                  ...
                  <div class="ml-4 flex items-center">
                    <div class="flex-1 bg-gray-200 rounded-full h-2 w-24 mr-3">
                      <div
                        ...
                        style={"width: #{min(100, (link.click_count / max(1, @total_clicks)) * 100 * 5)}%"}
                      >
                      </div>
                    </div>
              ...
              <%= for browser <- @browser_stats do %>
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    <div class="w-3 h-3 rounded-full mr-3" style={browser_color(browser.browser)}>
                    </div>
                  ...
                  <div class="flex items-center">
                    <div class="flex-1 bg-gray-200 rounded-full h-2 w-20 mr-3">
                      <div
                        ...
                        style={"#{browser_color(browser.browser)}; width: #{(browser.count / max(1, @total_clicks)) * 100}%"}
                      >
                      </div>
                    </div>
