defmodule UrlShortenerWeb.AdminDashboardLiveTest do
  ...
  describe "Admin Dashboard" do
    ...
    test "displays dashboard with time information", %{conn: conn} do
      ...
      # Should display the dashboard properly with metric data
      assert html =~ "Analytics Dashboard"
    ...
    test "handles division by zero in calculations", %{conn: conn} do
      ...
      # Avg clicks should be 0 when no links
      assert html =~ "0"
    end
